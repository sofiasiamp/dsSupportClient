...
source(here::here("tests/testthat/connection_to_datasets/init_local_settings.R"))
init.ip.address()
  ds.test_env <- new.env()
  ...
  ds.test_env$ip_address_4 <- ds.test_env$ping_address
  ...
  ds.test_env$user_4 <- getOption("opal.user", "administrator")
  ...
  ds.test_env$password_4 <- getOption("opal.password", "datashield_test&")
